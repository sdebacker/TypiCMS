    <div class="form-group">
        ...
        @if (method_exists($model, 'previewUri') and $previewUri = $model->previewUri())
        <a class="btn btn-default pull-right" href="{{ $previewUri }}?preview=true">@lang('validation.attributes.preview')</a>
        @endif
    </div>
